...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#fff', fontSize: 17, fontFamily: Fonts.display },
  headerMeta: { color: Colors.textMuted, fontSize: 12, fontFamily: Fonts.body, marginTop: 2 },
  videoModalBackdrop: {
    flex: 1,
  ...
  heroDescription: { color: Colors.textSecondary, fontSize: 13, lineHeight: 20, fontFamily: Fonts.body },
  ...
  legendTitle: { color: '#fff', fontSize: 14, fontFamily: Fonts.heading },
